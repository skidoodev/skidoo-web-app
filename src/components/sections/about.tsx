...
export const About = () => {
  return (
    <section id="about" className="relative font-open pt-20 pb-10">
      ...
      <div className="flex flex-col mx-auto max-w-6xl px-6 my-12">
        <div className="flex flex-col lg:flex-row items-center lg:items-center lg:justify-between lg:gap-20">
          ...
          <div className="relative group mt-8 lg:mt-0">
            <div className="w-[400px] h-[550px] rounded-2xl bg-gradient-to-r from-[#8711C1] to-[#2472FC] p-1 shadow-xl hover:shadow-2xl transition-all duration-300">
      ...
      <div className="flex flex-col mx-auto max-w-6xl font-open px-6 pt-12">
