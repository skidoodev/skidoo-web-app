...
export const Explainer = () => {
  return (
    <section className="py-20">
      <div className="mx-auto max-w-6xl p-6 bg-gray-50 bg-transparent">
        ...
        <div className="flex justify-center mt-8">
          <div className="relative group w-full aspect-video">
            <div className="w-full h-full rounded-2xl bg-gradient-to-r from-[#8711C1] to-[#2472FC] p-1 shadow-xl hover:shadow-2xl transition-all duration-300">
